				...
				<div class="product_autoshare_img_email_image">
					<div class="product_autoshare_img_main_wrapper">
						<div class="ced_pas_cross_image">
							<a class="button-primary ced_pas_cross_image" href="?<?php echo $url_params?>&ced_pas_close=true">x</a>
						</div>
						<div class="ced-recom">
							<h4>Cedcommerce recommendations for you </h4>
						</div>
						<div class="product_autoshare__col">
							<p> 
							...
							<div class="product_autoshare_banner">
								<a target="_blank" href="http://bit.ly/2LB1lZV"><img src="<?php echo plugins_url().'/product-auto-share/assets/images/market-place-2.jpg'?>" ></a>
							</div>
						</div>
						<br>
						<div class="product_autoshare__col">
							...
							<div class="product_autoshare_banner">
								<a target="_blank" href="http://bit.ly/2LB71TJ"><img src="<?php echo plugins_url().'/product-auto-share/assets/images/market-place.jpg'?>" ></a>
							</div>
